...
definitions_OCT = {"age related macular degeneration" : ["a degenerative lesion in the macular area"],
                   "drusens" : ["Multiple, small pigment epithelium detachment（PED）", "Moderate reflection below PED",
                                "Thin, continuous Bruch membranes are visible"],
                   "choroidal neovascularization" : ["The pigment epithelium was thickened, swollen, discontinuous, and "
                                                     "the reflection was enhanced.", "Intraretinal Fluid（IRF）",
                                                     "Subretinal Fluid（SRF）", "Pigment epithelium detachment（PED） "
                                                     "The reflection of IS/OS and the pigment epithelium layer is blocked.",
                                                     "Type 1 CNV, neovascularization originating from the choroid, "
                                                     "located beneath the RPE, also known as occult CNV. A double-layer "
                                                     "sign (irregular shallow detachment between the RPE and Bruch's "
                                                     "membrane) can be seen.", "Type 2 CNV: New blood vessels originating "
                                                     "from the choroid, passing through the retinal pigment epithelium "
                                                     "and growing beneath the retinal nerve fiber layer. Also known as "
                                                     "classic CNV", "Type 3 CNV: neovascularization originating from the "
                                                     "intermediate layer of the retina, growing towards the retinal "
                                                     "pigment epithelium. Also known as retinal angiomatous proliferation (RAP)."],
                   "central serous retinopathy" : ["Serous retinal detachment", "detachment of the retinal neuroepithelial "
                                                   "layer", "Punctate moderate to high reflectivity appears in the area "
                                                   "of serous retinal detachment", "Atrophy of the pigment epithelium "
                                                   "layer, disappearance of IS/OS.", "Pigment epithelium detachment"],
                   "diabetic retinopathy" : ["Microaneurysms, with high reflectivity at the edges and low reflectivity "
                                             "at the center", "Hard exudates, high-reflective bright spots between "
                                             "retinal layers", "Diabetic Retinal Inner Layer Dysfunction（DRIL）, the "
                                             "structure of the inner retina in the macular area is disordered and its "
                                             "boundaries are indistinguishable", "Intraretinal microvascular abnormalities, "
                                             "punctate high-reflective signals in the inner retina layer, with the "
                                             "internal limiting membrane protruding", "Retinal neovascularization, the "
                                             "internal limiting membrane is torn, and new blood vessels grow horizontally "
                                             "along the posterior hyaloid membrane"],
                   "diabetic macular edema" : ["The accumulation of intra-retinal fluid shows low reflectivity", "The "
                                               "thickness of the retinal neuroepithelial layer increases", "Detachment "
                                               "of the neuroepithelial layer with the subretinal fluid showing low "
                                               "reflectivity", "Cystic structures in the outer plexiform layer, with "
                                               "high-reflective intervals and low-reflective cystic cavities", "Absence "
                                               "of IS/OS signals"],
                   "retinal artery occlusion" : ["The fovea centralis deepens, the retina becomes edematous and thickened, "
                                                 "and the reflective signals of the inner retina are enhanced"],
                   "retinal vein occlusion" : ["Subretinal fluid", "Intraretinal fluid", "Macular hemorrhage, with moderate "
                                               "to high reflectivity in the anterior retina and disappearance of the "
                                               "reflectivity of the tissues behind it", "The foveal retina shows cystic "
                                               "dark areas, bulging, accompanied by detachment of the neuroepithelial layer",
                                               "The reflective signals of the ellipsoid zone and RPE layer are decreased "
                                               "and discontinuous", "Punctate high reflectivity can be seen under the fovea"],
                   "vitreomacular Interface Disease" : ["Vitreomacular traction leads to structural abnormalities in the macular area"],
                   "macular hole" : ["Partial or full-thickness absence of the retinal neuroepithelial layer"],
                   "macular hole stage1" : ["Traction between the pre-foveal retina and the vitreous cortex, separation "
                                            "of the retinal nerve fiber layer and the pigment epithelium layer in a small "
                                            "part of the fovea, shallowing of the macular fovea, visible retinoschisis "
                                            "in the neurosensory retina, rupture of the outer retina, and cystoid changes "
                                            "within the retina."],
                   "macular hole stage2" : ["Vitreous traction at the fovea, partial rupture of the neurosensory retina "
                                            "forming a full-thickness hole with a diameter less than 400 μm, often "
                                            "accompanied by a membrane cover, and without posterior vitreous detachment (PVD)."],
                   "macular hole stage3" : ["Vitreous traction at the fovea, rupture of the neurosensory retina forming "
                                            "a full-thickness hole with a diameter greater than 400 μm, with or without "
                                            "a small retinal membrane cover, and cystoid changes within the retina at the "
                                            "edge of the hole. There is no PVD"],
                   "macular hole stage4" : ["Rupture of the neurosensory retina forming a full-thickness hole with a "
                                            "diameter greater than 400 μm, complete posterior vitreous detachment (PVD, "
                                            "the pre-retinal vitreous was observed. The surfaces of the optic disc and "
                                            "the retina were smooth, and no vitreous attachment was found)."],
                   "epiretinal membrane" : ["Linear high-reflective signal bands on the inner surface of the macular "
                                            "retina", "The high-reflective bands cause the macular retina to bulge due "
                                            "to pulling, resulting in the disappearance of the foveal shape and accompanied "
                                            "by cystic fluid"],
                   "glaucoma" : ["The C/D value of a single eye is greater than 0.6.", "The difference in C/D values "
                                 "between the two eyes exceeds 0.2.", "The thickness of the nerve fiber layer is reduced.",
                                 "The thickness of the ganglion cell layer becomes thinner."],
                   "normal": ["healthy", "no findings", "no glaucoma", "no retinopathy"]}
